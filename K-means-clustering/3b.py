...
vectors = vectors.T
vectors = np.column_stack((vectors, np.square(np.linalg.norm(vectors, axis=1))))
...
# print('Error 1 (blue classified as red): {}%'.format(2*(error_br) / len(vectors) * 100))
# print('Error 2 (red classified as blue): {}%'.format(2*(error_rb) / len(vectors) * 100))
